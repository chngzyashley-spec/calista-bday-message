...
$('document').ready(function(){
		...
		$(window).resize(function(){
			...
			$('#b11').animate({top:240, left: vw-240},500);
	...
	$('#wish_message').click(function(){
		...
		$('#b6').attr('id','b66');
		$('#b7').attr('id','b77');
		$('#b11').animate({top:240, left: vw-165-30},500);
		$('#b22').animate({top:240, left: vw-110-30},500);
		$('#b33').animate({top:240, left: vw-55-30},500);
		$('#b44').animate({top:240, left: vw-30},500);
		$('#b55').animate({top:240, left: vw+55-30},500);
		$('#b66').animate({top:240, left: vw+110-30},500);
		$('#b77').animate({top:240, left: vw+165-30},500);
